-- Add Discord menu item
INSERT INTO menu_items (label, path, order_index, enabled)
VALUES ('Discord', '/discord', 5, true)
ON CONFLICT DO NOTHING;

-- Ensure the public_site_settings view includes Our Story and Discord content
-- Drop and recreate the view with all necessary keys
